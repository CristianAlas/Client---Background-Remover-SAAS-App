...
export const steps = [
  ...
  },
  {
    ...
    description: `Our tool automatically removes the background from your image.\n
        Next, you can choose a background color. Our most popular options\n
        are white and transparent backgrounds, but you can pick any color you like.`
  },
  {
    step: "Step 3",
    title: "Download your image",
    description: `fter selecting a new background color, download your photo and you're done!\n
        You can also save your picture in the Photoroom App by creating an account.`
  }
];

export const categories = ["Peaple", "Products", "Animals", "Cars", "Graphics"];
...
export const testimonials = [
  ...
  {
    id: 3,
    quote: "We were impressed by its ability to account for pesky, feathery hair without making an image look jagged and an", // Note: The original quote was truncated in the image
    author: "Michael Chen",
